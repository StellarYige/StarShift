...
await walk('dist');
for (const name of ['README.md', 'LICENSE', 'THIRD_PARTY_NOTICES.md', 'docs/TEST_REPORT.md', 'docs/ENGINE_EVALUATION.md', 'docs/online-validation.json']) entries[name] = new Uint8Array(await readFile(name));
